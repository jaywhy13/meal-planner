...
const pickGradient = (id: number): string => GRADIENTS[Math.abs(id) % GRADIENTS.length];
...
interface MealPlanCardProps {
  ...
  onView: (plan: MealPlanSummary) => void;
  onDelete: (plan: MealPlanSummary) => void;
}

const MealPlanCard = ({ plan, onView, onDelete }: MealPlanCardProps): React.ReactElement => {
