...
export interface WeekGridProps {
  ...
  meals: WeekGridMeal[];
  onAddMeal: (request: AddMealRequest) => void;
  onEditMeal: (meal: WeekGridMeal) => void;
}
...
const WeekGrid = ({
  ...
  const findMeal = (dayNum: number, mealType: MealType): WeekGridMeal | undefined =>
    meals.find((meal) => meal.day === dayNum && meal.meal_type === mealType);
