...
class Meal(models.Model):
    """A reusable, user-scoped meal: a named set of foods plus notes, independent of any schedule slot"""

    user = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True, related_name="meals")
    name = models.CharField(max_length=200)
...
class DailyMeal(models.Model):
    """A schedule slot: a calendar date and meal type in a meal plan, optionally filled by a reusable Meal"""
